        ...
        <div class="p-8">
            ...
            <form @submit.prevent="submit" class="space-y-5">
                ...
                <button
                    ...
                    class="w-full rounded-lg bg-primary-600 px-4 py-2.5 text-sm font-medium text-white shadow-sm outline-none hover:bg-primary-700 focus-visible:ring-2 focus-visible:ring-primary-600 disabled:opacity-50"
                >
